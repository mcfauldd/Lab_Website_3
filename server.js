...
app.get('/player_info', function(req, res){
    var nameAndID = 'SELECT name, id FROM football_players;';
    db.any(nameAndID)
	.then(function (nameAndID) {
	    res.render('pages/player_info', {
		my_title: "Player Info",
		nameAndID: nameAndID,
		specificInfo: "NOT_SET",
		specificGames: "NOT_SET"
	    })
	})
	.catch(function (err) {
	    console.log(err);
...
app.get('/player_info/post', function(req, res){
    ...
    var nameAndID = 'SELECT name, id FROM football_players;';
    var specificInfo = 'SELECT * FROM football_players WHERE id = ' + player_id + ';';
    var specificGames = 'SELECT COUNT(*) FROM football_games WHERE ' + player_id + ' = ANY(players);';

    db.task('get-everything', task => {
	return task.batch([
	    task.any(nameAndID),
	    task.any(specificInfo),
	    task.any(specificGames)
	]);
    })
